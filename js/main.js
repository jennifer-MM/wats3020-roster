...
class Student extends Person {
    ...
    calculateAttendance() {
        if (this.attendance.length > 0) {
            let counter = 0;
            //find total number of days present
...
class Course {
    ...
    addStudent() {
        let name = prompt("Enter student full name:", "Jennifer Menard");
        let email = prompt("Enter student's email:", "Jmenard@seattleu.edu");
    ...
    setTeacher() {
        let name = prompt("Enter full teacher name:", "Taylor Swift");
        let email = prompt("Enter teacher's email:", "tswift@seattleu.edu");
